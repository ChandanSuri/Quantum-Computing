...
class MyStrategy(GameBot):
    ...
    def play_action(self,
        ...
        '''
        New Strategy:
        1. Do nothing but just calculate the states based on previous actions for the first 50 rounds.
        Team 0:
        ...
        5. Else If the probability of state 1 is lower, and not playing X or R, then play Z (if state 0 has positive probability).
        6. Else If probability of state 1 is higher and near last rounds, play measure (M).
        '''
        ...
        if team == 0:
            if prev_turn['team1_action'] == GameAction.MEASURE or prev_turn['team0_action'] == GameAction.MEASURE:
                ...
                if (round_number < 98 and hand.count(GameAction.PAULIX) > 1) or round_number >= 98:
                    return GameAction.PAULIX if GameAction.PAULIX in hand else None
            ...
            elif self.current_state[0]**2 > self.current_state[1]**2 and round_number >= 98:
            ...
            if prev_turn['team1_action'] == GameAction.MEASURE or prev_turn['team0_action'] == GameAction.MEASURE:
                ...
                if (round_number < 98 and hand.count(GameAction.PAULIX) > 1) or round_number >= 98:
                    ...
                    return GameAction.PAULIZ if GameAction.PAULIZ in hand else None
            elif self.current_state[1]**2 > self.current_state[0]**2 and round_number >= 98:
                return GameAction.MEASURE if GameAction.MEASURE in hand else None
